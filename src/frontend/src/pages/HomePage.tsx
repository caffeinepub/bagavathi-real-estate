...
export default function HomePage() {
  usePageMeta({
    title: "Home",
    description:
      "Rishi Real Estate - Trusted Properties in Coimbatore, Tamil Nadu. Find your dream plot or building with us.",
  });
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Years of experience delivering quality real estate solutions",
    },
  ];
      ...
      <HeroParallax imageSrc="/assets/generated/home-hero-building.dim_1920x1080.png">
        <div className="text-center space-y-6 animate-fade-in">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-foreground leading-tight animate-slide-up">
            Welcome to Rishi Real Estate
          </h1>
          <p
            className="text-xl sm:text-2xl md:text-3xl text-muted-foreground font-medium animate-slide-up"
          ...
          <ScrollReveal>
            <div className="bg-gradient-to-r from-primary to-accent rounded-2xl p-12 text-center shadow-elevation-lg">
              ...
              <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
                ...
                find the perfect plot or building
              </p>
              <Link
                to="/contact"
